...
if (instCount === 0) {
  ...
  const institutesList = [
    ...
    ['advanced_engineering', 'Институт перспективной инженерии'],
    ['pyatigorsk', 'Пятигорский институт (филиал СКФУ)'],
    ['nevinnomyssk', 'Невинномысский технологический институт (филиал СКФУ)'],
    ['international_relations', 'Факультет международных отношений'],
    ['math_computer_science', 'Факультет математики и компьютерных наук имени профессора Н.И. Червякова'],
    ['petroleum_engineering', 'Факультет нефтегазовой инженерии'],
    ['physics_technology', 'Физико-технический факультет'],
    ['chemistry', 'Химический факультет'],
    ['psychology_pedagogy', 'Психолого-педагогический факультет'],
    ['food_engineering_biotechnology', 'Факультет пищевой инженерии и биотехнологий имени академика А.Г. Храмцова'],
    ['physical_culture_sports', 'Факультет физической культуры и спорта'],
    ['medical_bio', 'Медико-биологический факультет'],
    ['creative_industries', 'Высшая школа креативных индустрий']
];
